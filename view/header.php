    ...
    <div class="header grid">
        <div class="header__banner">
            <div class="grid wide header__container ">
                <a href="index.php?act=home" class="header__logo">
            ...
            <div class="header__banner-text grid wide">
                <div class="header__title">
                    ...
                    <?php 
                        ...
                        foreach ($kq as $nav) {
                            // Kiểm tra act của item hiện tại có trùng với act trong URL không
                           if ($nav['act'] === $currentAct) {
                               echo '<div class="header__title-main">'.$nav['tennav'].'</div>';
                           }  
                        }
                    ?>
                </div>
                <div class="header__path">
                    <div class="header__path-root">Home</div>
                    <?php 
                        // Lấy giá trị của tham số 'act' từ URL, mặc định là 'home' nếu không có act
                        $currentAct = isset($_GET['act']) ? $_GET['act'] : 'home';
                        foreach ($kq as $nav) {
                            // Kiểm tra act của item hiện tại có trùng với act trong URL không
                           if ($nav['act'] === $currentAct) {
                               echo '<div class="header__path-sections">'.$nav['tennav'].'</div>';
                           }  
                        }
                    ?>
                </div>
